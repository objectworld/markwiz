...
**현재 버전: 0.1.1** (2026-09-23). 변경 내용은 [릴리즈 노트](#릴리즈-노트)를 참고하세요.
...
| 파일 | 설명 |
|---|---|
| `bundle/nsis/Markwiz_0.1.1_x64-setup.exe` | 설치 프로그램(권장, WebView2가 없으면 자동 설치) |
| `bundle/msi/Markwiz_0.1.1_x64_en-US.msi` | MSI 설치 패키지 |
